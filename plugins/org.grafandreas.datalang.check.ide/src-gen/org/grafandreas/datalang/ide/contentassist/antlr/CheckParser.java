...
import org.grafandreas.datalang.ide.contentassist.antlr.internal.InternalCheckParser;
...
public class CheckParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, CheckGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getReqCheckAccess().getGroup(), "rule__ReqCheck__Group__0");
			builder.put(grammarAccess.getReqCheckAccess().getGroup_3(), "rule__ReqCheck__Group_3__0");
			builder.put(grammarAccess.getNamesAccess().getGroup(), "rule__Names__Group__0");
			builder.put(grammarAccess.getNamesAccess().getGroup_2(), "rule__Names__Group_2__0");
			...
			builder.put(grammarAccess.getChecksModelAccess().getBlocksAssignment(), "rule__ChecksModel__BlocksAssignment");
			builder.put(grammarAccess.getCheckBlockAccess().getReqAssignment_1(), "rule__CheckBlock__ReqAssignment_1");
			builder.put(grammarAccess.getCheckBlockAccess().getChecksAssignment_3(), "rule__CheckBlock__ChecksAssignment_3");
			builder.put(grammarAccess.getReqCheckAccess().getExprAssignment_0(), "rule__ReqCheck__ExprAssignment_0");
			builder.put(grammarAccess.getReqCheckAccess().getErrorTemplateAssignment_2(), "rule__ReqCheck__ErrorTemplateAssignment_2");
			builder.put(grammarAccess.getReqCheckAccess().getAttachToFieldsAssignment_3_1(), "rule__ReqCheck__AttachToFieldsAssignment_3_1");
			builder.put(grammarAccess.getNamesAccess().getAttrsAssignment_1(), "rule__Names__AttrsAssignment_1");
			builder.put(grammarAccess.getNamesAccess().getAttrsAssignment_2_1(), "rule__Names__AttrsAssignment_2_1");
			builder.put(grammarAccess.getErrorTemplateAccess().getMessageAssignment(), "rule__ErrorTemplate__MessageAssignment");
