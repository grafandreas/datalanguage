...
entryRuleIDAssignment returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getIDAssignmentRule()); }
	iv_ruleIDAssignment=ruleIDAssignment
	{ $current=$iv_ruleIDAssignment.current; }
	EOF;

// Rule IDAssignment
ruleIDAssignment returns [EObject current=null]
@init {
	enterRule();
}
@after {
