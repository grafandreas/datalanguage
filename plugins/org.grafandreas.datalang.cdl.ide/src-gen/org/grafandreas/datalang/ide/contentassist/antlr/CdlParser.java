 ...
 */
package org.grafandreas.datalang.ide.contentassist.antlr;
...
import org.grafandreas.datalang.ide.contentassist.antlr.internal.InternalCdlParser;
...
public class CdlParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, CdlGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getSimpleTypeAccess().getAlternatives_2_1(), "rule__SimpleType__Alternatives_2_1");
			builder.put(grammarAccess.getSimpleTypeAccess().getAlternatives_2_3(), "rule__SimpleType__Alternatives_2_3");
			builder.put(grammarAccess.getXNUMBERAccess().getAlternatives_3_0(), "rule__XNUMBER__Alternatives_3_0");
			builder.put(grammarAccess.getXNUMBERAccess().getAlternatives_3_1(), "rule__XNUMBER__Alternatives_3_1");
			...
			builder.put(grammarAccess.getRequirementTypeAccess().getGroup_2(), "rule__RequirementType__Group_2__0");
			...
			builder.put(grammarAccess.getAttributeAccess().getGroup_2_2(), "rule__Attribute__Group_2_2__0");
			...
			builder.put(grammarAccess.getSimpleTypeAccess().getGroup_3_2(), "rule__SimpleType__Group_3_2__0");
			builder.put(grammarAccess.getSimpleTypeAccess().getGroup_3_2_2(), "rule__SimpleType__Group_3_2_2__0");
			builder.put(grammarAccess.getFQNAccess().getGroup(), "rule__FQN__Group__0");
			builder.put(grammarAccess.getFQNAccess().getGroup_1(), "rule__FQN__Group_1__0");
			builder.put(grammarAccess.getXNUMBERAccess().getGroup(), "rule__XNUMBER__Group__0");
			builder.put(grammarAccess.getXNUMBERAccess().getGroup_3(), "rule__XNUMBER__Group_3__0");
			...
			builder.put(grammarAccess.getSpecificationModelAccess().getPackageAssignment(), "rule__SpecificationModel__PackageAssignment");
			builder.put(grammarAccess.getPackageAccess().getNameAssignment_1(), "rule__Package__NameAssignment_1");
			builder.put(grammarAccess.getPackageAccess().getMembersAssignment_2(), "rule__Package__MembersAssignment_2");
			builder.put(grammarAccess.getRequirementTypeAccess().getNameAssignment_1(), "rule__RequirementType__NameAssignment_1");
			builder.put(grammarAccess.getRequirementTypeAccess().getGeneralAssignment_2_1(), "rule__RequirementType__GeneralAssignment_2_1");
			builder.put(grammarAccess.getRequirementTypeAccess().getIdfieldsAssignment_4(), "rule__RequirementType__IdfieldsAssignment_4");
			builder.put(grammarAccess.getRequirementTypeAccess().getAttributesAssignment_5(), "rule__RequirementType__AttributesAssignment_5");
			...
			builder.put(grammarAccess.getAttributeAccess().getLowerBoundAssignment_2_1(), "rule__Attribute__LowerBoundAssignment_2_1");
			builder.put(grammarAccess.getAttributeAccess().getDeclaredUpperBoundAssignment_2_2_1(), "rule__Attribute__DeclaredUpperBoundAssignment_2_2_1");
			builder.put(grammarAccess.getAttributeAccess().getDefaultExprAssignment_3_1(), "rule__Attribute__DefaultExprAssignment_3_1");
			builder.put(grammarAccess.getEnumAccess().getNameAssignment_1(), "rule__Enum__NameAssignment_1");
			builder.put(grammarAccess.getEnumAccess().getLiteralsAssignment_3(), "rule__Enum__LiteralsAssignment_3");
			builder.put(grammarAccess.getEnumLiteralAccess().getNameAssignment_0(), "rule__EnumLiteral__NameAssignment_0");
			builder.put(grammarAccess.getEnumLiteralAccess().getValueAssignment_1_1(), "rule__EnumLiteral__ValueAssignment_1_1");
			builder.put(grammarAccess.getSimpleTypeAccess().getNameAssignment_1(), "rule__SimpleType__NameAssignment_1");
			builder.put(grammarAccess.getSimpleTypeAccess().getLowerRangeDecimalAssignment_2_1_0(), "rule__SimpleType__LowerRangeDecimalAssignment_2_1_0");
			builder.put(grammarAccess.getSimpleTypeAccess().getLowerRangeIntegerAssignment_2_1_1(), "rule__SimpleType__LowerRangeIntegerAssignment_2_1_1");
			builder.put(grammarAccess.getSimpleTypeAccess().getUpperRangeDecimalAssignment_2_3_0(), "rule__SimpleType__UpperRangeDecimalAssignment_2_3_0");
			builder.put(grammarAccess.getSimpleTypeAccess().getUpperRangeIntegerAssignment_2_3_1(), "rule__SimpleType__UpperRangeIntegerAssignment_2_3_1");
			builder.put(grammarAccess.getSimpleTypeAccess().getBaseTypeAssignment_3_1(), "rule__SimpleType__BaseTypeAssignment_3_1");
			builder.put(grammarAccess.getSimpleTypeAccess().getLowerBoundAssignment_3_2_1(), "rule__SimpleType__LowerBoundAssignment_3_2_1");
			builder.put(grammarAccess.getSimpleTypeAccess().getDeclaredUpperBoundAssignment_3_2_2_1(), "rule__SimpleType__DeclaredUpperBoundAssignment_3_2_2_1");
