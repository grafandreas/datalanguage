...
entryRuleChecksModel returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getChecksModelRule()); }
	iv_ruleChecksModel=ruleChecksModel
	{ $current=$iv_ruleChecksModel.current; }
	EOF;

// Rule ChecksModel
ruleChecksModel returns [EObject current=null]
@init {
	enterRule();
}
@after {
...
entryRuleCheckBlock returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getCheckBlockRule()); }
	iv_ruleCheckBlock=ruleCheckBlock
	{ $current=$iv_ruleCheckBlock.current; }
	EOF;

// Rule CheckBlock
ruleCheckBlock returns [EObject current=null]
@init {
	enterRule();
}
@after {
...
entryRuleReqCheck returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getReqCheckRule()); }
	iv_ruleReqCheck=ruleReqCheck
	{ $current=$iv_ruleReqCheck.current; }
	EOF;

// Rule ReqCheck
ruleReqCheck returns [EObject current=null]
@init {
	enterRule();
}
@after {
...
entryRuleErrorTemplate returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getErrorTemplateRule()); }
	iv_ruleErrorTemplate=ruleErrorTemplate
	{ $current=$iv_ruleErrorTemplate.current; }
	EOF;

// Rule ErrorTemplate
ruleErrorTemplate returns [EObject current=null]
@init {
	enterRule();
}
@after {
