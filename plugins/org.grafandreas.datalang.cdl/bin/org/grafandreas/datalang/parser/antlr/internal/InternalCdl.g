...
entryRuleSpecificationModel returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getSpecificationModelRule()); }
	iv_ruleSpecificationModel=ruleSpecificationModel
	{ $current=$iv_ruleSpecificationModel.current; }
	EOF;

// Rule SpecificationModel
ruleSpecificationModel returns [EObject current=null]
@init {
	enterRule();
}
@after {
...
@after {
	...
	(
		...
		{
			$current = $this_RequirementType_0.current;
			afterParserOrEnumRuleCall();
		}
		    |
		{
...
entryRuleXNUMBER returns [String current=null]:
	{ newCompositeNode(grammarAccess.getXNUMBERRule()); }
	iv_ruleXNUMBER=ruleXNUMBER
	{ $current=$iv_ruleXNUMBER.current.getText(); }
	EOF;

// Rule XNUMBER
ruleXNUMBER returns [AntlrDatatypeRuleToken current=new AntlrDatatypeRuleToken()]
@init {
	enterRule();
}
@after {
