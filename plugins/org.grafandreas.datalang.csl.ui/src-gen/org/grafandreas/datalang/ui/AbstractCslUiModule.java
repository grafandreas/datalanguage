...
import org.grafandreas.datalang.ide.contentassist.antlr.CslParser;
import org.grafandreas.datalang.ide.contentassist.antlr.PartialCslContentAssistParser;
import org.grafandreas.datalang.ide.contentassist.antlr.internal.InternalCslLexer;
import org.grafandreas.datalang.ui.contentassist.CslProposalProvider;
import org.grafandreas.datalang.ui.editor.CslEditor;
import org.grafandreas.datalang.ui.labeling.CslDescriptionLabelProvider;
import org.grafandreas.datalang.ui.labeling.CslLabelProvider;
import org.grafandreas.datalang.ui.outline.CslOutlineTreeProvider;
import org.grafandreas.datalang.ui.quickfix.CslQuickfixProvider;
import org.grafandreas.datalang.validation.CslValidatorConfigurationBlock;

/**
 * Manual modifications go to {@link CslUiModule}.
 */
@SuppressWarnings("all")
public abstract class AbstractCslUiModule extends DefaultXbaseUiModule {

	public AbstractCslUiModule(AbstractUIPlugin plugin) {
		super(plugin);
	}
	...
	public void configureHighlightingLexer(Binder binder) {
		binder.bind(org.eclipse.xtext.parser.antlr.Lexer.class)
			...
			.to(org.grafandreas.datalang.parser.antlr.internal.InternalCslLexer.class);
	}
	...
	public void configureContentAssistLexerProvider(Binder binder) {
		binder.bind(InternalCslLexer.class).toProvider(LexerProvider.create(InternalCslLexer.class));
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.validation.ValidatorFragment2
	public Class<? extends AbstractValidatorConfigurationBlock> bindAbstractValidatorConfigurationBlock() {
		return CslValidatorConfigurationBlock.class;
	}
	...
	public Class<? extends ILabelProvider> bindILabelProvider() {
		return CslLabelProvider.class;
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.ui.labeling.LabelProviderFragment2
	public void configureResourceUIServiceLabelProvider(Binder binder) {
		binder.bind(ILabelProvider.class).annotatedWith(ResourceServiceDescriptionLabelProvider.class).to(CslDescriptionLabelProvider.class);
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.ui.outline.OutlineTreeProviderFragment2
	public Class<? extends IOutlineTreeProvider> bindIOutlineTreeProvider() {
		return CslOutlineTreeProvider.class;
	}
	...
	public Class<? extends IssueResolutionProvider> bindIssueResolutionProvider() {
		return CslQuickfixProvider.class;
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.ui.contentAssist.ContentAssistFragment2
	public Class<? extends IContentProposalProvider> bindIContentProposalProvider() {
		return CslProposalProvider.class;
	}
	...
	public Class<? extends IPartialEditingContentAssistParser> bindIPartialEditingContentAssistParser() {
		return PartialCslContentAssistParser.class;
	}
	...
	public void configureCompareViewerTitle(Binder binder) {
		binder.bind(String.class).annotatedWith(Names.named(UIBindings.COMPARE_VIEWER_TITLE)).toInstance("Csl Compare");
	}
