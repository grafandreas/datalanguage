...
import org.grafandreas.datalang.ide.contentassist.antlr.internal.InternalCslParser;
import org.grafandreas.datalang.services.CslGrammarAccess;

public class CslParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		@Inject
		public NameMappings(CslGrammarAccess grammarAccess) {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, CslGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getIDAssignmentAccess().getGroup(), "rule__IDAssignment__Group__0");
			...
			builder.put(grammarAccess.getInstancesAccess().getNameAssignment_1(), "rule__Instances__NameAssignment_1");
			builder.put(grammarAccess.getInstancesAccess().getInstancesAssignment_2(), "rule__Instances__InstancesAssignment_2");
			builder.put(grammarAccess.getInstanceAccess().getDeclarationAssignment_0(), "rule__Instance__DeclarationAssignment_0");
			builder.put(grammarAccess.getInstanceAccess().getNameAssignment_1(), "rule__Instance__NameAssignment_1");
			builder.put(grammarAccess.getInstanceAccess().getIdsAssignment_3(), "rule__Instance__IdsAssignment_3");
			builder.put(grammarAccess.getInstanceAccess().getValuesAssignment_4(), "rule__Instance__ValuesAssignment_4");
			builder.put(grammarAccess.getIDAssignmentAccess().getDeclarationAssignment_1(), "rule__IDAssignment__DeclarationAssignment_1");
			builder.put(grammarAccess.getIDAssignmentAccess().getIdSpecAssignment_3(), "rule__IDAssignment__IdSpecAssignment_3");
			builder.put(grammarAccess.getValueAssignmentAccess().getDeclarationAssignment_0(), "rule__ValueAssignment__DeclarationAssignment_0");
			builder.put(grammarAccess.getValueAssignmentAccess().getValSpecAssignment_2(), "rule__ValueAssignment__ValSpecAssignment_2");
	...
	@Override
	protected InternalCslParser createParser() {
		InternalCslParser result = new InternalCslParser(null);
